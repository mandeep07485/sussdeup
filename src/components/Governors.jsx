      ...
      <div className="container-fluid Chancellor d-flex align-items-center text-center text-white">
        <div className="row w-100">
          <div className="col-12">
            <h4 className="display-5 fw-bold">Board of Governors</h4>
            <p className="lead fw-semibold mt-3">
              SUSSDEU:: Board of Governors
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="governor">
          <div className="row">
            <div className="col-md-6">
              ...
              <p>
                The <strong>Board of Governors (BoG)</strong> is the highest
                decision-making body of SUSSDEU, responsible for providing
                strategic direction, ensuring transparency, and upholding the
                vision and mission of the University. It consists of eminent
                leaders from academia, government, and industry, who bring
                diverse expertise and valuable insights to guide the
                institution.
              </p>
            </div>
            <div className="col-md-6">
              <img src="public/3.jpg"></img>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            <h2>Key Stakeholders and Their Roles:</h2>
            <br></br>
            <p>
              <strong>
                Kamboj Companionship (Skills, Education, Industry):
              </strong>
              Supports quality education, skills development, industry-driven
              curriculum, training, and career opportunities.
              <br></br>
              <br></br>
              <strong>Government of Punjab:</strong>
              Provides policy support, regulatory framework, and infrastructure
              development to make higher education accessible and globally
              competitive.
              <br></br>
              <br></br>
              <strong>Leading Industries:</strong>
              Offer industrial collaborations, real-world projects, research
              funding, internships, and placement opportunities for students.
              <br></br>
              <br></br>
              <br></br>
              ...
              <br></br>
              <br></br>
              <strong>Educational Professionals and Policymakers:</strong>
              Guide curriculum design, modern teaching methods, academic
              excellence, and future-ready policies.
              <br></br>
              <br></br>
              <br></br>
