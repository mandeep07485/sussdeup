    ...
    <>
      ...
      <section className="hero">
        ...
        <div className="hero-content">
          <h1 className="fw-bold">Residential Facilities</h1>
          <p className="lead">Comfort • Safety • Community</p>
          <button className="btn btn-warning mt-3">Discover SUSSDEU</button>
        </div>
      </section>
      ...
      <div className="container my-5">
        <h2 className="text-center mb-4">
          Hostel Facilities – Safe, Comfortable & Student-Friendly Living
        </h2>
        <p className="text-muted text-center">
          The campus provides thoughtfully designed hostel accommodations that
          ensure a safe, comfortable, and enriching living experience for
          students. Separate hostels for boys and girls accommodate over 2,000
          students with modern amenities, Wi-Fi, recreation rooms, study areas,
          and 24/7 security with CCTV and medical support.
        </p>

        <div className="row text-center mt-4">
          <div className="col-md-3">
            <div className="facility-card">
              <strong>Separate Accommodation</strong>
              <p>
                Secure hostels for boys and girls with supervised management.
              </p>
            </div>
          </div>
          <div className="col-md-3">
            <div className="facility-card">
              ...
              <p>
                Spacious housing for 2000+ students with well-ventilated rooms.
              </p>
            </div>
          </div>
          <div className="col-md-3">
            <div className="facility-card">
              ...
              <p>Wi-Fi, recreation rooms, and quiet study areas.</p>
            </div>
          </div>
          <div className="col-md-3">
            <div className="facility-card">
              <strong>Security & Medical Support</strong>
              <p>
                24/7 CCTV surveillance, security staff, and medical assistance.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="summary-box mt-4">
          Our hostels are more than just places to stay—they are home to a
          thriving community of students. With dedicated amenities, safety
          measures, and student-centric services, hostel life promotes comfort,
          well-being, and personal growth throughout the academic journey.
        </div>
      </div>
        ...
        <div className="row align-items-center">
          <div className="col-md-6">
            ...
            <p>
              ...
              Entrepreneurship University) is a not-for-profit organization with
              a collaborative platform to support education. Members can become
              Educators, Researchers, Innovators, or Industry Leaders
              contributing as Professors of Practice, Trainers under Skill
              India, or Administrators in the Indian education system.
            </p>
          </div>
