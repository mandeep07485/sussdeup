      ...
      <div className="about-section py-5">
        <div className="container">
          ...
          <div className="row align-items-center mb-5">
            ...
            <div className="col-md-6">
              <p>
                ...
                University Punjab, being established at Ludhiana, is envisioned
                as a premier model university to empower youth through
                world-class skill development, innovation and entrepreneurship,
                grounded in Indian culture, values and patriotism.
              </p>
            </div>
          </div>
          ...
          <div className="row align-items-center mb-5 flex-md-row-reverse">
            <div className="col-md-6 mb-3 mb-md-0">
              <img
                src="https://news.hybriques.com/hnn_files/2024/02/18877795646-860x645.png"
                className="img-fluid rounded shadow"
                alt="Shaheed Udham Singh"
              />
            </div>
            <div className="col-md-6">
              <p>
                SUSSDEU is being established to honor the legacy of Shaheed
                Udham Singh, the brave martyr who sacrificed his life in
                response to the Jallianwala Bagh massacre, where thousands of
                innocent Indians lost their lives. This university stands as a
                tribute to his courage and unwavering commitment to justice,
                aiming to inspire future generations with the same spirit of
                patriotism, resilience and service to the nation.
              </p>
            </div>
          </div>
          ...
          <div className="row mb-5">
            <div className="col">
              <p>
                Spread across 50 acres generously donated by the Kamboj
                Companionship and supported by a ₹500 crore investment, the
                university aims to place skills and practical learning at the
                heart of education. The university is being established by the
                Kamboj Education & Research Society, symbolising unity,
                secularism and growth.
              </p>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col">
              <p>
                In collaboration with the Government of Punjab, leading
                industries and international universities, the institution seeks
                to nurture industry-ready graduates, visionary entrepreneurs and
                socially responsible leaders capable of driving economic and
                social transformation in India and globally.
              </p>
            </div>
          </div>
        </div>
