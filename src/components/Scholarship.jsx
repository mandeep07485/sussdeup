...
function Scholarship() {
  const scholarships = [
    ...
    },
    {
      ...
      items: [
        "Family income < ₹2 Lakhs: 75% fee waiver",
        "Family income < ₹5 Lakhs: 50% fee waiver",
      ],
      icon: "💰",
    },
    {
      ...
      items: [
        "SC/ST/OBC: As per govt. norms",
        "Defense personnel children: 25% fee waiver",
        "Sports quota: Special consideration",
      ],
      icon: "🏆",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="scholarship-section py-5">
        <div className="container">
          <h2 className="text-center mb-5">Scholarships & Financial Aid</h2>
          <div className="row g-4">
            {scholarships.map((sch, idx) => (
              <div key={idx} className="col-md-4 d-flex">
                <div
                  className="scholarship-block text-white p-4 rounded shadow-lg w-100 d-flex flex-column"
                  style={{ background: sch.color }}
                >
                  <div className="icon text-center">{sch.icon}</div>
                  <h4 className="mt-3 text-center">{sch.title}</h4>
