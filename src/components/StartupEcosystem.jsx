  ...
  const startups = [
    {
      ...
      role: "Mentorship",
      impact:
        "Refine business models, connect with experts, scale successfully",
      icon: <FaLightbulb />,
      gradient: "linear-gradient(135deg, #0d6efd, #6c5ce7)",
    },
    {
      name: "Indian Angel Network",
      role: "Funding",
      impact: "Secure capital and gain guidance for business expansion",
      icon: <FaMoneyBillWave />,
      gradient: "linear-gradient(135deg, #198754, #00b894)",
    },
    {
      name: "NASSCOM",
      role: "Industry Connect",
      impact: "Connects startups with tech experts and corporate partners",
      icon: <FaNetworkWired />,
      gradient: "linear-gradient(135deg, #fd7e14, #e17055)",
    },
    {
      name: "CII Punjab",
      role: "Policy Support",
      impact: "Navigate government policies and access incentives",
      icon: <FaGavel />,
      gradient: "linear-gradient(135deg, #6f42c1, #a29bfe)",
    },
  ];
  ...
  return (
    <>
      ...
      <div className="startup-section">
        <h2 className="startup-title">Startup Ecosystem</h2>
