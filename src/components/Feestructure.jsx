  ...
  return (
    <>
      ...
      <div className="container my-5">
        <h2 className="text-center mb-4 fee-heading">Fee Structure (Annual)</h2>

        {/* Undergraduate Programs */}
        <h4 className="program-title text-primary">Undergraduate Programs</h4>
        ...
        {/* Postgraduate Programs */}
        <h4 className="program-title text-success">Postgraduate Programs</h4>
