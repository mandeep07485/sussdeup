        ...
        <div className="container">
          ...
          <div className="row mb-5">
            <div className="col text-center">
              <img
                src="https://silveroakuni.ac.in/upload/images/mission.webp"
                alt="Vision & Mission"
          ...
          <div className="row">
            ...
            <div className="col-md-6 mb-4">
              <div className="vision-card p-4 h-100">
                <h4 className="text-primary mb-3">Vision</h4>
                <p>
                  To emerge as a premier model university in India that empowers
                  youth through world-class industry-partnered skills training,
                  innovation and entrepreneurship, grounded in strong Indian
                  culture, values and patriotism, thereby producing
                  industry-ready graduates capable of driving sustainable
                  economic and social transformation in India and abroad.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-6 mb-4">
              <div className="vision-card p-4 h-100">
                <h4 className="text-success mb-3">Mission</h4>
                <p>
                  To nurture innovation, entrepreneurship and world-class skills
                  in students by providing industry-aligned training,
                  experiential learning, and exposure to global best practices,
                  all grounded in Indian culture, values, and patriotism,
                  thereby creating industry-ready leaders, visionary
                  entrepreneurs, and socially responsible professionals who can
                  drive sustainable economic growth and make a meaningful impact
