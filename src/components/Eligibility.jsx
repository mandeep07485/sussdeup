  ...
  return (
    <>
      ...
      <div className="container-fuild">
        <h1 className="eligibility">Eligibility Criteria</h1>
      </div>
      <div className="container">
          ...
          <div className="row">
            <div className="col-md-6">
              <div>
                ...
                <p>
                  {" "}
                  • Minimum 60% in 10+2 or equivalent <br></br>•
                  Mathematics/Science subjects for technical programs <br></br>•
      ...
      <div className="container">
        <div className="Postgraduate">
          <div className="row">
            <div className="col-md-6">
              <img src="public/FOEII-37.webp"></img>
            </div>
            <div className="col-md-6">
              <div>
                ...
                <p>
                  {" "}
                  • Bachelor's degree with minimum 55% marks<br></br>• Valid
                  entrance test scores (program-specific)<br></br>• Work
                  experience preferred for MBA programs
                </p>
              </div>
            </div>
          </div>
