...
import "./ResearchCenters.css";
import { FaRobot, FaIndustry, FaLightbulb } from "react-icons/fa";
...
function ResearchCenters() {
  ...
  return (
    <>
      ...
      <div className="research-section py-5">
        <div className="container">
          <h2 className="text-center mb-5 fw-bold">Research Centers</h2>

          <div className="row g-4">
            {/* AI & Data Science */}
            <div className="col-md-4">
              <div className="research-card shadow-lg p-4 h-100">
                <div className="icon-box">
                  <FaRobot />
                </div>
                <h4>Artificial Intelligence & Data Science</h4>
                <p>
                  Focus on <strong>ML, DL & NLP</strong> to create solutions for
                  prediction, image recognition, chatbots, and automation.
                </p>
                <ul>
                  <li>₹2 Cr worth equipment</li>
                  <li>15+ Ph.D. Faculty</li>
                  <li>Partners: Google, Microsoft, IBM</li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="research-card shadow-lg p-4 h-100">
                ...
                <h4>Industry 4.0 Research Lab</h4>
                <p>
                  Driving <strong>Smart Manufacturing, IoT, Automation</strong>{" "}
                  with robotics & real-time monitoring systems.
                </p>
                <ul>
                  <li>Advanced Sensors</li>
                  <li>Robotics Systems</li>
                  <li>Collab: Siemens, ABB, L&T</li>
                </ul>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="research-card shadow-lg p-4 h-100">
                ...
                <h4>Innovation & Entrepreneurship Hub</h4>
                <p>
                  Incubating <strong>15+ Startups</strong>, providing{" "}
                  <strong>₹5Cr+ funding</strong>, and ensuring a 70% survival
                  rate.
                </p>
                <ul>
                  <li>5,000 sq ft incubation space</li>
                  <li>Mentoring & Networking</li>
                  <li>Investor & Govt support</li>
                </ul>
              </div>
            </div>
          </div>
